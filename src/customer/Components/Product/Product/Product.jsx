...
export default function Product() {
  ...
  //This returns the query string portion of the current URL, starting from the ? symbol. 
  //For example, if the URL is https://example.com/page?name=John&age=30, location.search would return "?name=John&age=30"
                ...
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    {filters.map((section) => (
                      ...
                      {/* PRODUCT HEADER FOR PRODCT HEADING, SORT BUTTON, FILTERS*/}
